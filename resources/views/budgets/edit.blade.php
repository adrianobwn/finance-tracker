            ...
            <form action="{{ route('budgets.update', $budget->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="amount" value="{{ $budget->amount }}" min="0" step="0.01" class="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="0" required>
                    </div>
                </div>
